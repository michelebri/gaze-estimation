...
class GazeLLE(nn.Module):
    ...
    def forward(self, input):
        ...
        x = repeat_tensors(x, num_ppl_per_img) # repeat image features along people dimension per image
        ...
        heatmap_preds = split_tensors(x, num_ppl_per_img) # resplit per image
